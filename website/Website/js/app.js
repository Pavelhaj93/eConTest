...
"use strict";function Cookie(e){function i(){var e=document.cookie.split("; "),i=e.filter(function(e){return e.includes(t)})[0];return!!i}var t="privacy_policy",c=i(),o=e.querySelector(".agree");c||e.classList.add("privacy-policy-visible"),o.addEventListener("click",function(i){i.preventDefault(),document.cookie=t+"=1; expires=Fri, 31 Dec 9999 23:59:59 GMT; path=/",e.classList.remove("privacy-policy-visible")})}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=Cookie;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function Auth(e){function r(){var r=Array.from(e.querySelectorAll("[required]")),t=!0,a=[];return r.map(function(e){e.classList.remove("invalid"),e.value.trim()||(e.classList.add("invalid"),a.push(e),t=!1)}),t}function t(){return(0,_alert2.default)("Ověření Vašich údajů se nezdařilo. Zadejte prosím správné údaje. V případě potíží se prosím obraťte na naši zákaznickou podporu.","error",n)}var a=e.querySelector('input[name="birth"]'),o=e.querySelector('input[name="additional"]'),u=e.querySelector('button[type="submit"]'),n=$(e.querySelector(".status"));u.addEventListener("click",function(e){e.preventDefault(),$(n).empty();var u=r();if(u){var i=(0,_trim2.default)(a.value)==(0,_trim2.default)(dob);i?(console.warn("SEND REQUEST"),$.ajax({type:"",dataType:"jsonp",url:"http://google.com",data:{additional:o.value},success:function(e){e.success?console.warn("REDIRECT TO: Offer"):t(),console.log(e)},error:function(e){}})):t()}else(0,_alert2.default)("Prosím , vyplňte všechna požadovaná pole.","error",n)})}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=Auth;var _alert=require("../../components/alert"),_alert2=_interopRequireDefault(_alert),_trim=require("../../helpers/trim"),_trim2=_interopRequireDefault(_trim);

},{"../../components/alert":301,"../../helpers/trim":311}],308:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function FormOffer(e){window.onload=function(){function t(){return Array.from(e.querySelectorAll('input[type="checkbox"]'))}function n(){r.children("li").remove(),$.ajax({type:"GET",dataType:"jsonp",url:"http://google.com",beforeSend:function(){r.addClass("loading"),setTimeout(function(){},1e3)},success:function(e){var t=e.documents;u=t.length>0,u&&(0,_documentsList2.default)(r,t)},error:function(){r.addClass("error"),(0,_message2.default)(r,"appUnavailable")},complete:function(){r.removeClass("loading")}})}function o(){var e=!0,n=t();return n.map(function(t){!t.checked&&(e=!1)}),i.checked&&u||(e=!1),s.disabled=!e,e}var u=!1,r=$(e.querySelector(".list")),i=document.getElementById("customer-rights"),s=e.querySelector('[type="submit"]');n(),i.onchange=function(){e.onchange(),r.is(":visible")||$(r).slideDown(300)},e.onchange=function(e){o()},e.onsubmit=function(e){e.preventDefault(),u&&(window.location="thank-you.html")},o()}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=FormOffer;var _documentsList=require("../documents-list"),_documentsList2=_interopRequireDefault(_documentsList),_message=require("../message"),_message2=_interopRequireDefault(_message);
