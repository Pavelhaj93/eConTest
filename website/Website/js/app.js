...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function Auth(e){!function(r){function t(){var r=Array.from(e.querySelectorAll("[required]")),t=!0,a=[];return r.map(function(e){e.classList.remove("invalid"),e.value.trim()||(e.classList.add("invalid"),a.push(e),t=!1)}),t}function a(){return(0,_alert2.default)("Ověření Vašich údajů se nezdařilo. Zadejte prosím správné údaje. V případě potíží se prosím obraťte na naši zákaznickou podporu.","error",l)}var u=e.querySelector('input[name="birth"]'),i=e.querySelector('input[name="additional"]'),n=e.querySelector('button[type="submit"]'),l=r(e.querySelector(".status"));n.addEventListener("click",function(e){e.preventDefault(),r(l).empty();var n=t();if(n){var o=(0,_trim2.default)(u.value)==(0,_trim2.default)(dob),d=(0,_trim2.default)(i.value)==(0,_trim2.default)(additional);o&&d?console.warn("SEND REQUEST"):a()}else(0,_alert2.default)("Prosím , vyplňte všechna požadovaná pole.","error",l)})}(jQuery)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=Auth;var _alert=require("../../components/alert"),_alert2=_interopRequireDefault(_alert),_trim=require("../../helpers/trim"),_trim2=_interopRequireDefault(_trim);
