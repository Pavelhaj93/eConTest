...
"use strict";function printDocumentsList(e,t){!(e instanceof jQuery)&&(e=$(e)),t.map(function(t,i){var n=i+1,o=t.title,a=t.url,p=["<li>",'<input id="document-'+n+'" type="checkbox" autocomplete="off">','<label for="document-'+n+'">','Souhlasím s <a class="pdf" href="'+a+'" title="'+o+'" target="_blank">'+o+"</a>","</label>","</li>"].join("");0==i?e.prepend(p):e.append(p)});var i=arguments[2];if(i){var n=i.checked||!1,o=i.disabled||!1,a=e.find("input");a.prop("checked",n),o&&a.prop("disabled",!0)}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=printDocumentsList;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function FormOffer(e){window.onload=function(){function t(){return Array.from(e.querySelectorAll('input[type="checkbox"]'))}function n(){u.children("li").remove(),$.ajax({type:"GET",dataType:"jsonp",url:"http://google.com",success:function(e){var t=e.documents;r=t.length>0,r&&(0,_documentsList2.default)(u,t)},error:function(){u.addClass("error"),(0,_message2.default)(u,"appUnavailable")},complete:function(){u.removeClass("loading")}})}function o(){var e=!0,n=t();return n.map(function(t){!t.checked&&(e=!1)}),r||(e=!1),i.disabled=!e,e}var r=!1,u=$(e.querySelector(".list")),i=e.querySelector('[type="submit"]');n(),e.onchange=function(e){o()},i.onclick=function(e){e.preventDefault(),r&&(window.location="thank-you.html")},o()}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=FormOffer;var _documentsList=require("../documents-list"),_documentsList2=_interopRequireDefault(_documentsList),_message=require("../message"),_message2=_interopRequireDefault(_message);
