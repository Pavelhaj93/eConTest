...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}require("babel-polyfill"),require("svgxuse");var _init=require("./init"),_init2=_interopRequireDefault(_init),_factory=require("./factory"),_factory2=_interopRequireDefault(_factory),_cookie=require("./components/cookie"),_cookie2=_interopRequireDefault(_cookie),_authentication=require("./components/forms/authentication"),_authentication2=_interopRequireDefault(_authentication),_datepicker=require("./components/datepicker"),_datepicker2=_interopRequireDefault(_datepicker),_offer=require("./components/forms/offer"),_offer2=_interopRequireDefault(_offer),_acceptedDocuments=require("./components/accepted-documents"),_acceptedDocuments2=_interopRequireDefault(_acceptedDocuments),_checkAll=require("./components/check-all"),_checkAll2=_interopRequireDefault(_checkAll),_copyright=require("./components/copyright"),_copyright2=_interopRequireDefault(_copyright);window.app={start:function(e){(0,_init2.default)(_cookie2.default,document.body),(0,_init2.default)(_authentication2.default,document.getElementById("authentication")),(0,_init2.default)(_offer2.default,document.getElementById("offer")),(0,_factory2.default)(_checkAll2.default,document.querySelectorAll(".form .check-all")),(0,_init2.default)(_datepicker2.default,document.querySelector(".input-date")),(0,_init2.default)(_acceptedDocuments2.default,document.getElementById("accepted-documents")),(0,_init2.default)(_copyright2.default,document.getElementById("copyright"))}};

},{"./components/accepted-documents":300,"./components/check-all":302,"./components/cookie":303,"./components/copyright":304,"./components/datepicker":305,"./components/forms/authentication":307,"./components/forms/offer":308,"./factory":310,"./init":312,"babel-polyfill":1,"svgxuse":298}],300:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function AcceptedDocuments(e){$.ajax({url:"http://google.com",beforeSend:function(){e.classList.add("loading")},success:function(t){var s=t.documents;s.length>0&&(0,_documentsList2.default)(e,s,{checked:!0,disabled:!0})},error:function(){e.classList.add("error"),(0,_message2.default)(e,"appUnavailable")},complete:function(){e.classList.remove("loading")}})}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=AcceptedDocuments;var _documentsList=require("./documents-list"),_documentsList2=_interopRequireDefault(_documentsList),_message=require("./message"),_message2=_interopRequireDefault(_message);

},{"./documents-list":306,"./message":309}],301:[function(require,module,exports){
"use strict";function Alert(e){var t=arguments.length<=1||void 0===arguments[1]?"warning":arguments[1],r=arguments.length<=2||void 0===arguments[2]?null:arguments[2],a=['<div class="alert '+t+'">',e+'<a class="close" href=""></a>',"</div>"].join("");return r&&(r=r instanceof jQuery&&$(r),r.append(a)),$(".alert .close").on("click",function(e){e.preventDefault();var t=($(e.target),$(e.target).parent(".alert"));t.addClass("closing").slideUp(250).fadeOut(0,function(){t.remove()})}),a}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=Alert;

},{}],302:[function(require,module,exports){
"use strict";function CheckAll(e){var c=e.closest(".form");e.onclick=function(e){e.preventDefault();var t=e.target,l=Array.from(c.querySelectorAll('input[type="checkbox"]'));l.map(function(e){e.checked=!t.classList.contains("checked")}),t.classList.toggle("checked"),c.onchange()}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=CheckAll;
...
"use strict";function DateInput(e){e=$(e),e.datepicker({language:"cs",format:"dd. mm. yyyy",maxViewMode:2,autoclose:!0,orientation:"bottom right"}),$(".datepicker-dropdown").appendTo(e.parent("div"));var t=$(".ui-datepicker-trigger");t.on("click",function(t){t.preventDefault(),e.datepicker("show")})}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=DateInput;

},{}],306:[function(require,module,exports){
"use strict";function printDocumentsList(e,t){!(e instanceof jQuery)&&(e=$(e)),t.map(function(t,i){var o=i+1,a=t.title,n=t.url,l=["<li>",'<input id="document-'+o+'" type="checkbox" autocomplete="off">','<label for="document-'+o+'">','Souhlasím s <a class="pdf" href="'+n+'" title="'+a+'" target="_blank">'+a+"</a>","</label>","</li>"].join("");e.append(l)});var i=arguments[2];if(i){var o=i.checked||!1,a=i.disabled||!1,n=e.find("input");n.prop("checked",o),a&&n.prop("disabled",!0)}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=printDocumentsList;

},{}],307:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function Auth(e){!function(r){function t(){var r=Array.from(e.querySelectorAll("[required]")),t=!0,a=[];return r.map(function(e){e.classList.remove("invalid"),e.value.trim()||(e.classList.add("invalid"),a.push(e),t=!1)}),t}function a(){return(0,_alert2.default)("Ověření Vašich údajů se nezdařilo. Zadejte prosím správné údaje. V případě potíží se prosím obraťte na naši zákaznickou podporu.","error",i)}var o=e.querySelector('input[name="birth"]'),u=e.querySelector('input[name="additional"]'),n=e.querySelector('button[type="submit"]'),i=r(e.querySelector(".status"));n.addEventListener("click",function(e){e.preventDefault(),r(i).empty();var n=t();if(n){var l=(0,_trim2.default)(o.value)==(0,_trim2.default)(dob);l?(console.warn("SEND REQUEST"),r.ajax({type:"",dataType:"jsonp",url:"http://google.com",data:{additional:u.value},success:function(e){e.success?console.warn("REDIRECT TO: Offer"):a(),console.log(e)},error:function(e){}})):a()}else(0,_alert2.default)("Prosím , vyplňte všechna požadovaná pole.","error",i)})}(jQuery)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=Auth;var _alert=require("../../components/alert"),_alert2=_interopRequireDefault(_alert),_trim=require("../../helpers/trim"),_trim2=_interopRequireDefault(_trim);

},{"../../components/alert":301,"../../helpers/trim":311}],308:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function FormOffer(e){window.onload=function(){function t(){return Array.from(e.querySelectorAll('input[type="checkbox"]'))}function n(){u.children("li").remove(),$.ajax({type:"GET",dataType:"jsonp",url:"http://google.com",beforeSend:function(){u.addClass("loading"),setTimeout(function(){},1e3)},success:function(e){var t=e.documents;r=t.length>0,r&&(0,_documentsList2.default)(u,t)},error:function(){u.addClass("error"),(0,_message2.default)(u,"appUnavailable")},complete:function(){u.removeClass("loading")}})}function o(){var e=!0,n=t();return n.map(function(t){!t.checked&&(e=!1)}),i.checked&&r||(e=!1),s.disabled=!e,e}var r=!1,u=$(e.querySelector(".list")),i=document.getElementById("customer-rights"),s=e.querySelector('[type="submit"]');n(),i.onchange=function(){e.onchange(),u.is(":visible")||$(u).slideDown(300)},e.onchange=function(e){o()},s.onclick=function(e){e.preventDefault(),r&&(window.location="thank-you.html")},o()}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=FormOffer;var _documentsList=require("../documents-list"),_documentsList2=_interopRequireDefault(_documentsList),_message=require("../message"),_message2=_interopRequireDefault(_message);

},{"../documents-list":306,"../message":309}],309:[function(require,module,exports){
"use strict";function Message(e,a){!(e instanceof jQuery)&&(e=$(e));var o={appUnavailable:["<h3>Nedostupnost aplikace</h3>","<p>Omlouváme se Vám za nedostupnost aplikace. Příčinou může být právě probíhající odstávka. Prosím opakujte akci později.</p>"]},p=o[a].join("");e.append(p)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=Message;
...
"use strict";function trim(e){return e.replace(/ /g,"")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=trim;
