...
*/
function OpenFieldsEditorWindow(itemId, stateId, planId, templateId, fieldValues, isAction, isNewItem) {
...
*/
function GetFieldEditorUrl(itemId, stateId, planId, templateId, fieldValues, isAction, isNewItem) {
