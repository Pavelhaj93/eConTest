(function(speak) {
  require.config({
    paths: {
      itemJS: "/sitecore/shell/client/Business Component Library/version 2/Assets/lib/speakItem/speakItem",
      session: "/sitecore/shell/client/Business Component Library/version 2/Assets/lib/scSession"
    }
  });

  speak.component(["itemJS", "session"], function (itemJS) {
    var lastPage = 0
      , isReady = false
      , pendingRequests = 0;
    ...
    var getOptions = function(control) {
      ...
      if (pageSize) {
        ...
        if (control.PagingMode == "appending") {
    ...
    var completed = function(items, totalCount, result) {
      ...
      if (this.PagingMode == "appending" && lastPage > 0) {
    ...
    return {
      ...
      initialize: function () {
        this.defineProperty("PagingMode", "appending");
      },
