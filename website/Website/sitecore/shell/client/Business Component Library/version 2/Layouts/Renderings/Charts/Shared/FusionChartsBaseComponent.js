(function (speak) {
  ...
  require.config({
    paths: {
      chartAttributes: "/sitecore/shell/client/Business Component Library/version 2/Layouts/Renderings/Charts/Shared/ChartAttributes",
      chartPalette: "/sitecore/shell/client/Business Component Library/version 2/Layouts/Renderings/Charts/Shared/ChartPalette",
      chartTemplateProperties: "/sitecore/shell/client/Business Component Library/version 2/Layouts/Renderings/Charts/Shared/ChartTemplateProperties",
      fusionCharts: "/sitecore/shell/client/Business Component Library/version 2/Assets/lib/deps/FusionCharts/fusioncharts",
      fusionChartsAdapter: "/sitecore/shell/client/Business Component Library/version 2/Layouts/Renderings/Charts/Shared/FusionChartsAdapter",
    }
  });

  define(["sitecore", "fusionChartsAdapter", "chartAttributes", "chartPalette", "chartTemplateProperties", "fusionCharts"], function (_sc, chartAdapter, chartAttributes, chartPalette, chartTemplateProperties) {
    return speak.extend(chartTemplateProperties, {
      ...
      setProgressIndicatorPosition: function (pi) {
        var piComponent = this.app[this.Id + "ProgressIndicator"];
        if (piComponent) {
      ...
      toggleProgressIndicator: function (status) {
        var pi = $('[data-sc-id="' + this.Id + 'ProgressIndicator"]');
