 ...
 * jQueryPresenter
 *
 * Built: Mon Oct 27 2014 16:25:47 GMT+0000 (GMT Standard Time)
      ...
      (function () {
        var setupOptions = function () {
          ...
          this.options.forEach(function (optionDescriptor) {
            var valueFromComponent = this[optionDescriptor.pluginProperty || optionDescriptor.name];

            if (valueFromComponent) {
              this.pluginOptions[optionDescriptor.name] = valueFromComponent;
            } else {
              this.pluginOptions[optionDescriptor.name] = optionDescriptor.defaultValue;
            }
          }, this);
        },
