  ...
  var fusionChartsAdapter = {
    ...
    createCategories: function (arrayData, dataMapping) {
      ...
      var categories = [],
        ...
        category = {},
        categoryFilter = dataMapping.categoryFilter ? this.removeCurlyBrackets(dataMapping.categoryFilter).split(this.propertySeperator) : null,
        filteredCategories = [],
        tempDataArray = [],
        i,
        dataRow,
    ...
    getSeriesKeys: function (arrayData, dataMapping) {
      ...
      if (dataMapping.seriesFilter) {
        return this.removeCurlyBrackets(dataMapping.seriesFilter).split(this.propertySeperator);
      }
    ...
    createDataset: function (arrayData, dataMapping, seriesKeys, localization) {
      ...
      var dataset = [],
        ...
        seriesFilter = dataMapping.seriesFilter ? this.removeCurlyBrackets(dataMapping.seriesFilter).split(this.propertySeperator) : null,
        arrayDataLength = arrayData.length,
        j,
        seriesObj,
        i,
