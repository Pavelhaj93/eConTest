define([
  ...
  var ctor = function () {
    ...
    window.parent.Sitecore.PageModes.ChromeControls.prototype.renderExpandCommand = function () { return ""; };
    window.parent.Sitecore.PageModes.Chrome.prototype.filterCommands = function (commands) {
      ...
      for (var i = 0; i < commands.length; i++) {
        ...
        if (window.parent.$sc.inArray(command.click, restrictedCommands) < 0) {
