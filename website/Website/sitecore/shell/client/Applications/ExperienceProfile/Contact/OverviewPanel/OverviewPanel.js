  ...
  var app = sc.Definitions.App.extend({
    ...
    initInfoPanel: function (baseUrl, contactId) {
      ...
      providerHelper.getData(
        ...
        $.proxy(function (jsonData) {
          this.NameValue.set(textProperty, cintelUtil.getFullName(jsonData));
          ...
          this.PhoneValue.set("text", cintelUtil.getFullTelephone(jsonData.preferredPhoneNumber.Value));
